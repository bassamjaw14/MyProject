...
table.insert(credits, {"UNDERGROUND", "center", 2304, fonts.credits.title})
table.insert(credits, {"Created by Bassam Jawish", "center", 4608, fonts.credits.me})
table.insert(credits, {"This is my final project (CS50x).", "center", 7040})
table.insert(credits, {"Everyone who helped with testing this project", "center", 9472})
table.insert(credits, {"Special Thanks to: David Malan \"Our great teacher\",", "center", 9600})
